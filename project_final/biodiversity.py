...
stat, pval, dof, exp = chi2_contingency(contingency)
pval
...
stat, pval2, dof, exp = chi2_contingency(contingency2)
pval2
...
min_detectable_effect = 100.0 * 0.05 / 0.15
min_detectable_effect
sample_size = 510
min_detectable_effect, sample_size
...
bryce_weeks = sample_size / 250.0
yellowstone_weeks = sample_size / 507.0
